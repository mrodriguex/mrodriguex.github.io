...
\begin{itemize}[leftmargin=12pt]
    \item Brindo servicios de ingeniería de software e infraestructura para sistemas empresariales a medida y plataformas internas.
    \item Desarrollé proyectos independientes recientes como RetailBase, RetailBase.Identity, poc-vite-crud, hard.core.web, HookHubNet, ScepServer y ari64.
    \item Administré VPS, VPN, correo, colaboración y herramientas de CI/CD, incluyendo automatización de despliegues, endurecimiento y soporte operativo.
    \item Sigo un pipeline \textit{Spec-Driven} asistido con GitHub Copilot que abarca descubrimiento de requerimientos, análisis, diseño, refinamiento, construcción, pruebas, despliegue, monitoreo y mantenimiento.
\end{itemize}
