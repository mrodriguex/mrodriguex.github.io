...
\begin{itemize}[leftmargin=12pt]
    ...
    \item Sigo un pipeline de desarrollo Spec-Driven asistido de punta a punta con GitHub Copilot, que cubre descubrimiento de requerimientos, análisis, diseño de especificaciones, refinamiento, construcción de la solución, pruebas, despliegue, monitoreo y mantenimiento.
\end{itemize}
